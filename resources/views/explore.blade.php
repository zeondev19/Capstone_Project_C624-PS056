...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="{{ asset('/temlplates/css/style.css') }}" rel="stylesheet">
</head>
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-light navbar-expand-lg py-4">
                <a href="{{ url('/') }}" class="navbar-brand d-flex align-items-center">
                    <img src="{{ ('/templates/img/logo teman cater.png') }}" style="width: 55px; height: 55px;" alt="Logo">
    ...
    <div class="container-fluid bg-light py-6 my-6 mt-0">
        <div class="container text-center animated bounceInDown">
            <h1 class="display-1 mb-4">Catering</h1>
            <ol class="breadcrumb justify-content-center mb-0 animated bounceInDown">
                <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                <li class="breadcrumb-item text-dark" aria-current="page">Explore</li>
            </ol>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <div class="container mt-5">
        <div class="row" id="catering-list">
        @foreach ($user as $item)
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="{{ asset('/templates/img/event-5.jpg') }}" class="card-img-top" alt="cateringku}">
                    <div class="card-body">
                        <h5 class="card-title">{{$item->name}}</h5>
                        <p class="card-text">{{$item->alamat}}</p>
                        <button class="btn btn-primary"
                            onclick="window.location.href='{{route('detail.tampilan',$item->id)}}';">Details</button>
                    </div>
                </div>
            </div>
        @endforeach
